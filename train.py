...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default="data/dogImages", help='Path to data')
    ...
    parser.add_argument('--net', type=str, default="vgg16_tf", help='Select the network to use', choices=["scratch, vgg16_tf, resnet50_tf"])
...
if __name__ == "__main__":
    ...
    dog_breed_classifier_pipeline.train(num_epochs=args.num_epochs, loss_fn=loss_fn, optimizer=optimizer, device=device, name=args.net)